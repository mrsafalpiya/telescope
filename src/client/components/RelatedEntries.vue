        ...
        <div>
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='logs' && logs.length">
                ...
                <tr v-for="entry in logs">
                    ...
                    <td class="table-fit">
                        <span class="badge fw-light" :class="'badge-'+logLevelClass(entry.content.level)">
                            {{entry.content.level}}
                        </span>
                    </td>
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='queries' && queries.length">
                ...
                <tr v-for="entry in queries">
                    ...
                    <td class="table-fit">
                        <span class="badge bg-danger fw-light" v-if="entry.content.slow">
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='models' && models.length">
                ...
                <tr v-for="entry in models">
                    ...
                    <td class="table-fit">
                        <span class="badge fw-light" :class="'badge-'+modelActionClass(entry.content.action)">
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='gates' && gates.length">
                ...
                <tr v-for="entry in gates">
                    ...
                    <td class="table-fit">
                        <span class="badge fw-light" :class="'badge-'+gateResultClass(entry.content.result)">
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='jobs' && jobs.length">
                ...
                <tr v-for="entry in jobs">
                    ...
                    <td class="table-fit">
                        <span class="badge fw-light" :class="'badge-'+jobStatusClass(entry.content.status)">
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='events' && events.length">
                ...
                <tr v-for="entry in events">
                    <td :title="entry.content.name">
                        ...
                        <span class="badge bg-info fw-light ms-2" v-if="entry.content.broadcast">
                            Broadcast
                        </span>
                    </td>
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='cache' && cache.length">
                ...
                <tr v-for="entry in cache">
                    ...
                    <td class="table-fit">
                        <span class="badge fw-light" :class="'badge-'+cacheActionTypeClass(entry.content.type)">
                            {{entry.content.type}}
                        </span>
                    </td>
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='mails' && mails.length">
                ...
                <tr v-for="entry in mails">
                    <td>
                        ...
                        <span class="badge bg-secondary fw-light ms-2" v-if="entry.content.queued">
                            Queued
                        </span>
            ...
            <table class="table table-hover table-sm mb-0" v-show="currentTab=='client_requests' && clientRequests.length">
                ...
                <tr v-for="entry in clientRequests">
                    <td class="table-fit pe-0">
                        <span class="badge fw-light" :class="'badge-'+requestMethodClass(entry.content.method)">
                    ...
                    <td class="table-fit">
                        <span class="badge fw-light" :class="'badge-'+requestStatusClass(entry.content.response_status !== undefined ? entry.content.response_status : null)">
